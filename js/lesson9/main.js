...
//     block.innerHTML = `<h2> ${element.title} - ${element.monthDuration}</h2>`;
...
//     elem.innerHTML = `<h1>${element.title}</h1>
//     <p>${element.monthDuration}</p>`;
...
for (const element of coursesArray) {
    ...
    divElem2.innerText = element.monthDuration;

    let htmlParagraphElement = document.createElement('p');
    htmlParagraphElement.innerText = element.hourDuration;

    let PElement1 = document.createElement('p');
    PElement1.innerText = element.modules;

    divElem.append(h2elem, divElem2, htmlParagraphElement, PElement1)
