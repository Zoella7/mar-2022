...
//     if(friends.length >= 3){
//         console.log(`This array is to long`);
//     }
//     else{
...
// let a = -53;
//
// let res = a > 0 && a < 0? 'positive' : 'negative'
// console.log(res);
...
//
//
//     let question = prompt('name of js?')
...
//
// let flat = prompt('Tell me the number of your flat');
// if( flat < 20){
//     console.log('You live in first entrance');
// }
// else if ( flat > 20 && flat < 48 ){
//     console.log('You live in second entrance');
// }
// else if ( flat > 49 && flat < 90 ){
//     console.log('You live in third entrance');
// }
